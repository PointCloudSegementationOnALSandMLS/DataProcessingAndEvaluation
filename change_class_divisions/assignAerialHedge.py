...
#points = np.load('Daten_Essen/Allee/grids/mobile/Lsplits/normalized/train/grid_normalized_5.npy')
    ...
    try:
        hedgePoints= scipy.io.loadmat('./Daten_Essen/Allee/grids/aerial/hedge/grid{}/VoxelLabelData/grid_{}_Label_1.mat'.format(i,i))["L"]
    except: 
        hedgePoints= points
    ...
    np.save("Daten_Essen/Allee/grids/aerial/hedgeOriginal/grid_{}".format(i), complete)
