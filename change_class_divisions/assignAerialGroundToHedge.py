...
#points = np.load('Daten_Essen/Allee/grids/mobile/Lsplits/normalized/train/grid_normalized_5.npy')
    try:
        points = np.load("Daten_Essen/Allee/grids/aerial/hedge/train/grid_{}.npy".format(i), allow_pickle=True)
    except:
        points = np.load("Daten_Essen/Allee/grids/aerial/hedge/validation/grid_{}.npy".format(i), allow_pickle=True)
    ...
    np.save("Daten_Essen/Allee/grids/aerial/ground_hedge/grid_{}".format(i), complete)
